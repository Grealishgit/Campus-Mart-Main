            ...
            <View className="flex-1 px-4">
                ...
                <View className="space-y-6">
                    ...
                    <View className="mt-4 space-y-2">
                        ...
                        {errors.email
                            ? <Text className="mt-2 ml-1 text-sm text-red-500">{errors.email}</Text>
                            : <Text className="mt-3 ml-1 font-medium text-md text-primary">Your Yegistered School email must end in .ac.ke or .edu</Text>
                        }
                    </View>
                    ...
                    <View className="mt-5 space-y-2">
                        ...
                        {errors.password && <Text className="mt-2 ml-1 text-sm text-red-500">{errors.password}</Text>}
                    </View>
                    ...
                    <View className="flex-row items-center justify-center py-4 mt-3">
                        <Text className="text-lg text-gray-500 font-display">Don't have an account? </Text>
                        <Pressable onPress={() => router.push('/(auth)')}>
                            <Text className="text-xl font-display-bold text-primary">Sign Up</Text>
                        </Pressable>
                    </View>
                </View>
            </View>
